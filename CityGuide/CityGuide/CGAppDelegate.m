...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    london.cityDescription = @"The capital of the United Kingdom and England."; london.cityPicture = [UIImage imageNamed:@"London.jpg"];
    ...
    sydney.cityDescription = @"The largest city in Australia."; sydney.cityPicture = [UIImage imageNamed:@"Sydney.jpg"];
    City *madrid = [[City alloc] init];
    madrid.cityName = @"Madrid";
    madrid.cityDescription = @"The capital and largest city of Spain."; madrid.cityPicture = [UIImage imageNamed:@"Madrid.jpg"];
